export default function Features() {
  ...
  return (
    <section className="py-12 sm:py-16 md:py-20 px-4 bg-gradient-to-br from-brand-dark to-brand-darker text-white">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {features.map((feature, index) => (
            <div 
              key={index}
              className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 sm:p-8 hover:bg-white/20 transition-all duration-300 border border-white/10"
            >
              <div className="text-brand-yellow mb-3 sm:mb-4">{feature.icon}</div>
              <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3 text-brand-yellow">
                {feature.title}
              </h3>
