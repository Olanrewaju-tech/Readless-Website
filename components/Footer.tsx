      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 mb-6 sm:mb-8">
          ...
          <div className="sm:col-span-2">
            ...
            <p className="text-xs sm:text-sm text-gray-500">
              © {new Date().getFullYear()} Readless. All rights reserved.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm sm:text-base text-gray-400">
              ...
              <li><a href="#categories" className="hover:text-brand-yellow transition-colors">Categories</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 sm:space-y-3">
              ...
              <li>
                <a 
                  href="mailto:info@getreadless.tech" 
              ...
              <li>
                <a 
                  href="https://www.linkedin.com/company/getreadless" 
                  target="_blank"
        ...
        <div className="border-t border-gray-700 pt-6 sm:pt-8">
          <div className="text-center text-xs sm:text-sm text-gray-500">
            <p>© {new Date().getFullYear()} Readless. All rights reserved.</p>
          </div>
        </div>
      </div>
    </footer>
