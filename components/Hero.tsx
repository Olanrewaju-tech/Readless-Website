  ...
  return (
    <section className="relative bg-gradient-to-br from-brand-dark via-brand-darker to-black text-white py-16 px-4 overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        ...
        <div className="absolute bottom-10 right-10 w-72 h-72 bg-brand-yellow rounded-full filter blur-3xl"></div>
      </div>
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
          ...
          <button 
            disabled
            className="relative bg-gray-700 text-gray-400 px-8 py-4 rounded-xl font-semibold text-lg cursor-not-allowed flex items-center gap-3 hover:bg-gray-600 transition-all group w-full sm:w-auto justify-center"
          >
